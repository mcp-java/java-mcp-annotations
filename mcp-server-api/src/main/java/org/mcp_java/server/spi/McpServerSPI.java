 ...
 * {@link ServiceLoader#load(Class, ClassLoader)} using the classloader of {@code McpServerSPI}.
 * <p>
 * Users should use static constructor methods, for example {@link TextContent#of(String)}, rather
 * than this interface and must not implement this interface.
 */
public interface McpServerSPI {
    ...
    /**
     * Creates a new {@link CompletionResult} with a list of suggestions that is the complete set of
    ...
    /**
     * Creates a new {@link CompletionResult} with a list of suggestions that is not the complete
    ...
    /**
     * Creates a new {@link CompletionResult} which includes a list of suggestions and the total
     ...
     */
    default TextContent newTextContent(String text) {
        return textContentBuilder(text).build();
    }
    ...
    /**
     * Creates a new {@link AudioContent}
     * 
     * @param data the audio data
     * @param mimeType the MIME type of the audio data
     * @return the new audio content
     */
    default AudioContent newAudioContent(byte[] data, String mimeType) {
        return audioContentBuilder(data, mimeType).build();
    }
    ...
    /**
     * Creates a new {@link ImageContent}
     * 
     * @param data the image data
     * @param mimeType the MIME type of the image data
     * @return the new image content
     */
    default ImageContent newImageContent(byte[] data, String mimeType) {
        return imageContentBuilder(data, mimeType).build();
    }
    ...
    /**
     * Creates a new {@link ResourceResponse} with text content and no MIME type
     * 
    ...
    /**
     * Creates a new {@link ResourceResponse} with text content and the given MIME type
     * 
     * @param uri the resource URI
     * @param text the text content
    ...
    /**
     * Creates a new {@link ResourceResponse} with binary content and no MIME type
     * 
     * @param uri the resource URI
    ...
    /**
     * Creates a new {@link ResourceResponse} with binary content and the given MIME type
     * 
     * @param uri the resource URI
     * @param data the binary content
     * @param mimeType the MIME type
