...
public record ListResourcesRequest(
    ...
    /**
     * Creates a list resources request without pagination.
     *
     * @return new request
     */
    public static ListResourcesRequest create() {
        return new ListResourcesRequest(null);
    }

    /**
     * Creates a list resources request with pagination.
     *
     * @param cursor the pagination cursor
     * @return new request
     */
    public static ListResourcesRequest withCursor(Cursor cursor) {
